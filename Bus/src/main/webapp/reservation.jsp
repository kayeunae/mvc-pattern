		...
		<section>
			...
			<div>
				<div>
					...
					<div>
						<dl>
							<dt>아이디</dt>
							<dd>
								<input type="text" name="pass_id" maxlength="10" placeholder="아이디 입력(영어)" />
							</dd>
						</dl>
						<dl>
							<dt>이름</dt>
							<dd>
								<input type="text" name="pass_name" maxlength="6" placeholder="이름 입력" />
							</dd>
						</dl>
						<dl>
							<dt>생년월일</dt>
							<dd>
								<input type="text" name="pass_birth" maxlength="6" placeholder="생년월일(6자리)" />
							</dd>
						</dl>
						<dl>
							<dt>연락처</dt>
							<dd>
								<input type="text" name="pass_phone" maxlength="12" />
							</dd>
						</dl>
					</div>
					<div>
					...
					<div>
						...
						<dl>
							<dt>예약 매수</dt>
							<dd>
								<select id="tck" name="count" onchange="selectBoxValue(this.value)">
				...
				<div>
					...
					<button type="reset"><a href="view">돌아가기</a></button>
				</div>
		</section>
